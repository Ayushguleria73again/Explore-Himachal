    ...
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="flex items-center gap-4 mb-12">
        ...
        <div>
          ...
          <p className="text-3xl font-black tracking-tighter text-gray-950">Culinary Heritage</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div>
            <h3 className="text-5xl font-black tracking-tighter text-gray-950 mb-6 uppercase">{cuisine.name}</h3>
          ...
          <div className="flex items-start gap-4 p-6 border-l-4 border-emerald-500 bg-emerald-50/50 rounded-r-3xl">
